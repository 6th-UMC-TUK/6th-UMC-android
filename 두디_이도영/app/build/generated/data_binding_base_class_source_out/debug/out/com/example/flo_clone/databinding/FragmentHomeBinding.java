...
public final class FragmentHomeBinding implements ViewBinding {
  ...
  @NonNull
  public final ImageView homePannelBackgoundIv;
  ...
  private FragmentHomeBinding(@NonNull FrameLayout rootView,
      ...
      @NonNull ImageView homePannelBackgoundIv, @NonNull ImageView homePannelBtnNuguIv,
    ...
    this.homePannelBackgoundIv = homePannelBackgoundIv;
  ...
  public static FragmentHomeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.home_pannel_backgound_iv;
      ImageView homePannelBackgoundIv = ViewBindings.findChildViewById(rootView, id);
      if (homePannelBackgoundIv == null) {
        break missingId;
      }
      ...
      return new FragmentHomeBinding((FrameLayout) rootView, homePannelAlbumImgIv,
          homePannelAlbumInfoTv, homePannelAlbumSingerTv, homePannelAlbumTitleTv,
          homePannelBackgoundIv, homePannelBtnNuguIv, homePannelBtnPlayIv, homePannelBtnSettingIv,
